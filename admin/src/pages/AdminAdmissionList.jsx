            ...
            {admissions.map((item) => (
              <tr key={item._id} className="hover:bg-gray-50">
                <td className="p-3 border">
                  {item.photo ? (
                    <img
                      src={`https://api.iisd.io/uploads/${item.photo}`}
                      alt="student"
                ...
                <td className="p-3 border text-xs space-y-1">
                  {item.idProof && (
                    <a
                      href={`https://api.iisd.io/uploads/${item.idProof}`}
                      target="_blank"
                  ...
                  {item.addressProof && (
                    <a
                      href={`https://api.iisd.io/uploads/${item.addressProof}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-blue-600 underline block"
                    >
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                {selectedAdmission.photo && (
                  <img
                    src={`https://api.iisd.io/uploads/${selectedAdmission.photo}`}
                    alt="Student"
              ...
              <div>
                ...
                {selectedAdmission.idProof && (
                  <a
                    href={`https://api.iisd.io/uploads/${selectedAdmission.idProof}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-blue-600 underline block"
                  >
              ...
              <div>
                ...
                {selectedAdmission.addressProof && (
                  <a
                    href={`https://api.iisd.io/uploads/${selectedAdmission.addressProof}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-blue-600 underline block"
                  >
              ...
              <div>
                ...
                {selectedAdmission.uploadSign && (
                  <a
                    href={`https://api.iisd.io/uploads/${selectedAdmission.uploadSign}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-red-600 underline block"
                  >
