...
export default function EstablishmentAffiliationForm() {
  return (
    <div className="my-10 px-4 sm:px-6 md:px-0">
      <div className="max-w-4xl mx-auto p-6 border-[10px] border-dashed border-[#ea5a21]">
        ...
        <p className="text-center text-base sm:text-lg text-gray-500 mb-6">
          ...
          <br />
          APPLICATION FORM FOR ESTABLISHMENT OR AFFILIATION OF VOCATIONAL, SKILL TRAINING & EDUCATION CENTRE
        </p>
        ...
        <form className="space-y-6">
          ...
          <div className="flex flex-col">
            <label className="mb-1 text-base font-medium">
              Name & Address of Existing Institute or where you want to start
            </label>
            <input
              type="text"
          ...
          <div className="flex justify-center mt-6 space-x-4">
            ...
            {/* <button
              type="button"
              onClick={() => (window.location.href = "/select-exam-date")}
