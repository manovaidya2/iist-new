...
export default function FranchiseHero() {
  return (
    <section
      className="text-white relative overflow-hidden bg-cover bg-center bg-no-repeat h-sm"
      style={{
        backgroundImage:
          "linear-gradient(rgba(26,78,146,0.88), rgba(26,78,146,0.88)), url('https://images.unsplash.com/photo-1529070538774-1843cb3265df?w=1920')",
      }}
    >
      {/* Decorative shapes */}
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="lg:w-1/2 text-center lg:text-left">
            ...
            <p className="text-lg md:text-xl mb-8">
              Partner with IISD to bring world-class skill education to your region.
              Build a profitable business while making a meaningful impact on your community.
            </p>
  ...
  <img
    src="https://images.unsplash.com/photo-1598257006458-087169a1f08d?w=900"
    alt="IISD Franchisee"
